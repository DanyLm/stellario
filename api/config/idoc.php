...
return [
    ...
    'logo' => 'https://cdn-icons-png.flaticon.com/512/599/599505.png',
    ...
    'description' => 'Doc de spécification pour API.',
    ...
    'servers' => [
        [
            'url' => config('app.url'),
            'description' => 'Environnement de stagging.',
        ],
    ],
